...
chart_version="1.0.1"
local_chart_dir="${component_dir}/chart/nested-root/charts/nested-sub"
local_packaged_chart_dir="${component_dir}/commands"
local_packaged_chart_file="${local_packaged_chart_dir}/nested-sub-${chart_version}.tgz"
artifactory_chart_url="https://common.repositories.cloud.sap/artifactory/landscaper-examples/guided-tour/nested-sub-${chart_version}.tgz"
